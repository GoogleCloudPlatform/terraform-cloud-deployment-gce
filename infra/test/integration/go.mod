module github.com/HSA-Integration/terraform-cloud-deployment-gce/infra/test/integration
...
require (
	...
	github.com/GoogleCloudPlatform/cloud-foundation-toolkit/infra/blueprint-test v0.5.2 // indirect
