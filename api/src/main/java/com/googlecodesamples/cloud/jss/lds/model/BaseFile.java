...
public class BaseFile extends FileMeta {
  ...
  public BaseFile(FileMeta fileMeta, String resourceBasePath) {
    BeanUtils.copyProperties(fileMeta, this);
    this.setUrl(resourceBasePath + fileMeta.getPath());
    this.setThumbUrl(resourceBasePath + this.genThumbnailPath());
    this.setCreateTime(fileMeta.getCreateTime());
    this.setUpdateTime(fileMeta.getUpdateTime());
  }
